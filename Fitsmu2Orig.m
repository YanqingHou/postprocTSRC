function [fitresult, gof] = Fitsmu2Orig(Pf, mu,ns)
%CREATEFITS(PF,MU)
%  Create fits.
%
...
str3=strcat('q1= ',num2str(paravalues(3)),', 95% [',num2str(parabnds(1,3)),',',num2str(parabnds(2,3)),' ]');
str4=strcat('q2= ',num2str(paravalues(4)),', 95% [',num2str(parabnds(1,4)),',',num2str(parabnds(2,4)),' ]');
str5=strcat('q3= ',num2str(paravalues(5)),', 95% [',num2str(parabnds(1,5)),',',num2str(parabnds(2,5)),' ]');

str6=strcat('SSE: ',num2str(gof(4).sse));
str7=strcat('ad R^2: ',num2str(gof(4).adjrsquare));
str8=strcat('RMSE: ',num2str(gof(4).rmse));
% str8=strcat('ReRMSE: ',num2str(RealRMSE));
